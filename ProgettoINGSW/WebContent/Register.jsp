...
<form method="post" action="RegisterUser">
  <div class="container">
    ...
    <label for="email"><b>Nick</b></label>
    <input type="text" placeholder="Enter Nick" name="nick" id="nick" required>
    
    <label for="email"><b>Nome</b></label>
    <input type="text" placeholder="Enter Nome" name="nome" id="nome" required>
    
    <label for="email"><b>Cognome</b></label>
    ...
    <input type="password" placeholder="Enter Password" name="pdw" id="psw" required>
